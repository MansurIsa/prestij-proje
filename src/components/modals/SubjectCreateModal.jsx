...
import { categoryChange, modalCloseFunc, modalOverlayFunc, setRefreshed, subjectCreateNameFunc } from '../../redux/MainReducer';
...
const SubjectCreateModal = () => {
    ...
    const { refreshed,categoryListArr,categorySelectValue,subjectCreateName } = useSelector(state => state.Data)

    const subjectCreate=(e)=>{
        e.preventDefault()
        const data={
            name: subjectCreateName,
        ...
        axios({
            ...
            method: "POST",
            url: `${baseUrl}service/subject-list-create/`,
            data
        }).then(resp => {
            console.log(resp);
            if (resp.status === 201) {
    ...
    <div className="modal_container">
            ...
            <div className="branch_create_modal_card">
                ...
                <form onSubmit={subjectCreate}>
                    <input value={subjectCreateName} onChange={(e) => dispatch(subjectCreateNameFunc(e.target.value))} type="text" placeholder='Enter fənn name' />
